...
constexpr uint64_t driver_input_show_history_seconds = 10;
constexpr uint64_t max_speed = 300;
constexpr uint64_t driver_input_plot_dot_size = driver_input_show_history_seconds * samples_per_second;
} // namespace acc_engineer
